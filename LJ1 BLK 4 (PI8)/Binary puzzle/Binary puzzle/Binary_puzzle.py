...
def input_error_correction_veld(invul_veld, moeilijkheidsgraad):
    ...
    error_loop = True
    while error_loop and invul_veld[0] > moelijkheidsgraad or invul_veld[0] < 0:
    ...
    while error_loop:
        try:
            ...
            if invul_veld[1] > moeilijkheidsgraad or invul_veld[1] < 0:
                invul_veld[1] = input('U heeft iets anders ingetypt bij de rij nummer\n' +
                                      '        probeer alstublieft opnieuw: ')
                print()               
            else:            
    ...
    while error_loop:
        try:
            ...
            print()
            invul_veld[2] = input('U heeft iets anders ingetypt bij de rij nummer\n' +
                                  '        probeer alstublieft opnieuw: ')
            print()
        else:
